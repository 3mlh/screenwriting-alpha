-- ── 019: Private script search semantic text RPC ─────────────────────────────
--
-- Threads semantic_text through the existing search chunk replacement RPC so
-- the current indexing path can persist semantic payload text before vector
